    ...
    <div class="row no-gutters">
        ...
        <div class="col-md-8">
            <div class="card-body">
                ...
                <p class="card-text"><small class="text-muted">주소 : ${restaurant.address}</small></p>
                <p class="card-text"><small class="text-muted">연락처 : ${restaurant.phone}</small></p>
                <p class="card-text"><small class="text-muted">평점 : </small></p>

                <hr>
                <p class="card-text review-text">${restaurant.description}</p>
