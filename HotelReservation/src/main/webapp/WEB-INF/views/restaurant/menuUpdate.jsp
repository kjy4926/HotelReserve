	...
	<form class="container" action="/admin/restaurant/menu/update" method="post" enctype="multipart/form-data">
	  <fieldset>
	    ...
	    <div class="form-group">
	      ...
	      <input value="${menu.name}" type="text" class="form-control" id="name" name="name" placeholder="메뉴명을 입력하세요">
	    </div>
	    <div class="form-group">
	      <label for="phone" class="form-label mt-4">가격</label>
	      <input value="${menu.price}" type="text" class="form-control" id="price" name="price" placeholder="가격을 입력하세요">
	    </div>
	    <div class="form-group">
