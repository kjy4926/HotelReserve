            ...
            <table>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <c:if test="${category eq '숙소'}">
						<select name="hotel" class="form-select" style="width:200px;height:40px;">
                        	<%-- 호텔코드 선택하는 메뉴 출력--%>
                        	<option selected disabled> hotelcode 선택 </option>
                        	<option value="hotel">{hotel.seq}</option>
                            <option value="hotel">{hotel.seq}</option>
                        </select>
                        </c:if>
                        </div>
                ...
                <tr class="common-tbl__item">
                    ...
                    <td>
                        <input  name="title" class="form-control" placeholder="제목을 입력" style="width: 600px" type="text"/>
                    </td>
                </tr>
                ...
                <tr class="common-tbl__item">
                    ...
                    <td>
                        <textarea class="form-control" name="description" placeholder="무었을 도와드릴까요?" rows="30" cols="84"></textarea>
                    </td>
                </tr>
            </table>
			<br>
