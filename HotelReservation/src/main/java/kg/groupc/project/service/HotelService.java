...
public class HotelService {
	...
	public int getHotelCount(String keyword){//검색해서 나오는 데이터 수로 최대 페이지 정하는 용도
		int count;
		...
		if(keyword == null |keyword == "") {//호텔메뉴 눌렀을 시 최초로 보여지는 화면, 별점순으로 정렬합니다
	 		hotelList = queryFactory.selectFrom(hotel)
	...
	public List<HotelMainFormDto> searchPageSimple(String keyword, int page){
